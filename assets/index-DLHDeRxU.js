...
/*! jQuery v3.7.1 | (c) OpenJS Foundation and other contributors | jquery.org/license */ (function (
  ...
  })(typeof window < "u" ? window : Gr, function (A, ae) {
    var V = [],
    ...
    i.extend({
      ...
      i.each(["height", "width"], function (e, t) {
        i.cssHooks[t] = {
          get: function (n, r, o) {
            if (r)
              return !jr.test(i.css(n, "display")) ||
...
`
    ...
    return (
      (i.noConflict = function (e) {
        return (
          A.$ === i && (A.$ = Xr), e && A.jQuery === i && (A.jQuery = Ur), i
        );
      }),
...
var Yr = Kn.exports;
const b = Jr(Yr),
  Qr = "https://secure.geonames.org/countryCode?",
  Kr = "mrryt247",
  Zr =
