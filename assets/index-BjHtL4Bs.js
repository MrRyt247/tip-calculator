...
/*! jQuery v3.7.1 | (c) OpenJS Foundation and other contributors | jquery.org/license */ (function (
  ...
  (function (j, ae) {
  ...
  })(typeof window < "u" ? window : Gr, function (j, ae) {
    var V = [],
      ...
      q = j.document,
      rr = { type: !0, src: !0, nonce: !0, noModule: !0 };
    function on(e, t, n) {
      var r,
        o,
    ...
    (i.fn = i.prototype =
      ...
      i.extend({
        ...
        isXMLDoc: function (e) {
          ...
          return !ir.test(t || (n && n.nodeName) || "HTML");
        },
        merge: function (e, t) {
    ...
    (function () {
      ...
      try {
        g.apply((V = $.call(Ae.childNodes)), Ae.childNodes),
          V[Ae.childNodes.length].nodeType;
      } catch {
        g = {
          apply: function (f, h) {
            Ht.apply(f, $.call(h));
            ...
            (ne = function (m, y) {
              ...
              return (
                ...
                (!P.sortDetached && y.compareDocumentPosition(m) === T)
                  ? m === a || (m.ownerDocument == Ae && A.contains(Ae, m))
                    ? -1
                    : y === a || (y.ownerDocument == Ae && A.contains(Ae, y))
                    ? 1
                    : r
      ...
      for (e in ((A.matches = function (l, f) {
        return A(l, null, null, f);
      }),
      (A.matchesSelector = function (l, f) {
        ...
        return 0 < A(f, a, null, [l]).length;
      }),
      (A.contains = function (l, f) {
      ...
      ((t = i.expr =
        {
          ...
          pseudos: {
            ...
            lang: K(function (l) {
              return (
                gt.test(l || "") || A.error("unsupported lang: " + l),
            ...
            target: function (l) {
              var f = j.location && j.location.hash;
      ...
      function mt(l, f) {
        ...
        return f ? C.length : C ? A.error(l) : N(l, k).slice(0);
      }
      function Dt(l) {
          ...
          (L = O(
            ...
            (k = function (H, I, D, te, oe) {
              ...
              if (((ye += X), T && X !== ye)) {
                ...
                if (H) {
                  if (0 < ye)
                    for (; X--; ) ze[X] || xe[X] || (xe[X] = or.call(te));
                  xe = Ot(xe);
                }
                g.apply(te, xe),
                  oe &&
      ...
      (Xn.prototype = t.filters = t.pseudos),
        ...
        (A.setDocument = Me),
        (A.tokenize = mt),
        (A.escape = i.escapeSelector),
        (A.getText = i.text),
        (A.isXML = i.isXMLDoc),
        (A.selectors = i.expr),
        (A.support = i.support),
        (A.uniqueSort = i.uniqueSort);
    })();
        ...
        function (e, t) {
          i.fn[e] = function (n, r) {
            ...
            return (
              ...
              1 < this.length &&
                (pr[e] || i.uniqueSort(o), fr.test(e) && o.reverse()),
              this.pushStack(o)
            );
          };
        }
    ...
    (i.fn.ready = function (e) {
      ...
      (q.readyState !== "loading" && !q.documentElement.doScroll)
        ...
        : (q.addEventListener("DOMContentLoaded", wt),
          j.addEventListener("load", wt));
    var je = function (e, t, n, r, o, a, s) {
        var c = 0,
          u = e.length,
          p = n == null;
        if (Xe(n) === "object")
          for (c in ((o = !0), n)) je(e, t, c, n[c], !0, a, s);
        else if (
          r !== void 0 &&
          ((o = !0),
          M(r) || (s = !0),
    ...
    function we(e) {
      return e.replace(hr, "ms-").replace(gr, mr);
    }
    var at = function (e) {
    ...
    function dn(e, t, n) {
      ...
      if (n === void 0 && e.nodeType === 1)
        if (
          ((r = "data-" + t.replace(yr, "-$&").toLowerCase()),
    ...
    Ie.getRootNode &&
      (Je = function (e) {
        return (
          ...
          e.getRootNode(xr) === e.ownerDocument
        );
      });
    var Tt = function (e, t) {
      return (
    ...
    function Ze(e, t, n, r) {
      ...
      var o,
        ...
        x = t[0],
        S = M(x);
      if (S || (1 < v && typeof x == "string" && !P.checkClone && Tr.test(x)))
      ...
      if (
        ...
        for (c = (s = i.map(ce(o, "script"), kr)).length; g < v; g++)
          (u = o),
            g !== d &&
        ...
        if (c)
          for (
            p = s[s.length - 1].ownerDocument, i.map(s, Sr), g = 0;
            g < c;
            g++
          )
            (u = s[g]),
              yn.test(u.type || "") &&
                ...
                (u.src && (u.type || "").toLowerCase() !== "module"
                  ...
                  : on(u.textContent.replace(Cr, ""), u, p));
      }
      return e;
    }
    function Cn(e, t, n) {
    ...
    i.extend({
      ...
      i.each(["height", "width"], function (e, t) {
        i.cssHooks[t] = {
          get: function (n, r, o) {
            if (r)
              return !Ar.test(i.css(n, "display")) ||
    ...
    function _t() {
      Et &&
        (q.hidden === !1 && j.requestAnimationFrame
          ? j.requestAnimationFrame(_t)
          : j.setTimeout(_t, i.fx.interval),
        i.fx.tick());
    }
    function qn() {
      return (
        ...
        stop: function (e, t, n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (a in c) c[a] && c[a].stop && Nr.test(a) && r(c[a]);
              for (a = s.length; a--; )
                s[a].elem !== this ||
                  (e != null && s[a].queue !== e) ||
    ...
    i.fn.extend({
      attr: function (e, t) {
        return je(this, i.attr, e, t, 1 < arguments.length);
      },
    ...
    var Or = /^(?:input|select|textarea|button)$/i,
      Lr = /^(?:a|area)$/i;
    function We(e) {
    ...
    i.fn.extend({
      prop: function (e, t) {
        return je(this, i.prop, e, t, 1 < arguments.length);
      },
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : Or.test(e.nodeName) || (Lr.test(e.nodeName) && e.href)
                ? 0
                : -1;
            },
          },
        ...
        if (
          ...
          if (!r && !g.noBubble && !Ue(n)) {
            for (
              ...
              d.push(a), (s = a);
            s === (n.ownerDocument || q) &&
              d.push(s.defaultView || s.parentWindow || j);
          }
...
`
          ...
          function Be(F, G, ht, Qt) {
            ...
            u ||
              ...
              ht &&
                (He = (function (re, Z, se) {
                  for (
                    var Pe, le, A, Q, K = re.contents, U = re.dataTypes;
                    U[0] === "*";
                  ...
                  if (A) return A !== U[0] && U.unshift(A), se[A];
                })(d, R, ht)),
              !ke &&
              ...
              (He = (function (re, Z, se, Pe) {
                ...
                for (A = rt.shift(); A; )
                  if (
                    (re.responseFields[A] && (se[re.responseFields[A]] = Z),
                    !U &&
                      Pe &&
                      re.dataFilter &&
    ...
    return (
      (i.noConflict = function (e) {
        return (
          j.$ === i && (j.$ = Xr), e && j.jQuery === i && (j.jQuery = Ur), i
        );
      }),
      typeof ae > "u" && (j.jQuery = j.$ = i),
      i
    );
  });
})(Kn);
...
const b = Jr(Yr),
  ...
  Zr = void 0;
let Yn, Zn;
const er = b(".wrapper .item"),
  ei = b(".item label"),
  Qn = b(".button img").attr("src");
let vt,
  yt,
  it = 0;
    ...
    if (!(ee >= de)) {
      ...
      b(".skip").click(() => {
        clearInterval(qe),
          clearInterval(Le),
          b(".button").text("").append("<img>").click(xt),
          b(".button img").addClass("arrow").attr({ src: Qn, alt: "arrow-up" }),
          b(".skip").css({ filter: "opacity(0)" }),
          setTimeout(() => {
            b(".skip").css("display", "none");
          }, 120),
          b("#total").html(ae.format(j));
      });
    }
  }
  function Re() {
